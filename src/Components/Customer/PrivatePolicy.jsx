export default function PrivatePolicy() {
    return (
        <div className="m-5">
            ...
            <p>
                TORANO&nbsp;chỉ thu thập các loại thông tin cơ bản liên quan đến
                đơn đặt hàng gồm:……
            </p>
            <p>
            ...
            <ul>
                <li>
                    Thông tin cá nhân của khách hàng được sử dụng đúng vào mục
                    đích của việc thu thập và cung cấp;
                </li>
                <li>
                ...
                <li>
                    ...
                    TORANO, không sử dụng các thông tin của Khách hàng được biết
                    đến theo các phương thức khác;
                </li>
                <li>Thời gian lưu trữ và bảo mật thông tin:</li>
                <li>
                    <p>
                        Chỉ cho phép các đối tượng sau được tiếp cận với thông
                        tin của Khách hàng:
                    </p>
                    <ol>
                        <li>
                            Người thực hiện việc cung cấp hàng hóa, dịch vụ từ
                            TORANO&nbsp;theo yêu cầu của Khách hàng;
                        </li>
                        <li>
                            Người thực hiện việc chăm sóc Khách hàng đã sử dụng
                            hàng hóa, dịch vụ của TORANO;
                        </li>
                        <li>
                            Người tiếp nhận và xử lý các thắc mắc của Khách hàng
                            trong quá trình sử dụng hàng hóa, dịch vụ của
                            TORANO;
                        </li>
            ...
            <p>
                <b>2. Cách thức bảo mật thông tin khách hàng:</b>
            </p>
            <p>
                ...
                Khách hàng, TORANO&nbsp;sẽ có trách nhiệm thông báo vụ việc cho
                cơ quan chức năng điều tra xử lý kịp thời và thông báo cho Khách
                ...
                mật 100%. Vì vậy, TORANO&nbsp;không cam kết chắc chắn rằng các
                thông tin tiếp nhận từ Khách hàng được bảo mật tuyệt đối.
            </p>
            <p>
                <b>3. Trách nhiệm bảo mật thông tin Khách hàng</b>
            </p>
            <p>
                Khách hàng vui lòng chỉ cung cấp đúng và đủ các thông tin theo
                yêu cầu của TORANO&nbsp;đặc biệt tránh cung cấp các thông tin
                liên quan đến tài khoản ngân hàng khi chưa được mã hóa thông tin
            ...
            <p>
                ...
                phải tự xác định được nguồn tiết lộ thông tin. TORANO&nbsp;không
                chịu trách nhiệm khi thông tin Khách hàng bị tiết lộ mà không có
                căn cứ xác đáng thể hiện TORANO&nbsp;là bên tiết lộ thông tin.
            </p>
            <p>
            ...
            <p>
                <b>4. Luật áp dụng khi xảy ra tranh chấp</b>
            </p>
            <p>
