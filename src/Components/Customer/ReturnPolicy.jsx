    ...
    return (
        <>
            <div className="content-pageDetail typeList-style m-5">
                ...
                <p>
                    Sản phẩm nguyên giá chỉ được đổi 01 lần duy nhất sang sản
                    phẩm nguyên giá khác và không thấp hơn giá trị sản phẩm đã
                    mua.
                </p>
                <p>
                    Sản phẩm giảm giá/khuyến mại ít hơn 50%&nbsp;được đổi 01 lần
                    sang màu khác hoặc size khác trên cùng 1 mã trong điều kiện
                    còn sản phẩm hoặc theo quy chế chương trình (nếu có). Nếu
                    sản phẩm đổi đã hết hàng khi đó KH sẽ được đổi sang sản phẩm
                    khác có giá trị ngang bằng hoặc cao hơn. Khách hàng&nbsp;sẽ
                    thanh toán phần tiền chênh lệch nếu sản phẩm đổi có giá trị
                    cao hơn sản phẩm đã mua.
                </p>
                <p>
                    Chính sách chỉ áp dụng khi sản phẩm còn hóa đơn mua hàng,
                    còn nguyên nhãn mác, thẻ bài đính kèm sản phẩm và sản phẩm
                    không bị dơ bẩn, hư hỏng bởi những tác nhân bên ngoài cửa
                    hàng sau khi mua sản phẩm.
                </p>
                <p>Sản phẩm đồ lót và phụ kiện&nbsp;không được đổi trả.</p>
                <p>
                    <strong>2. ĐIỀU KIỆN ĐỔI SẢN PHẨM</strong>
                </p>
                <p>
                    Đổi hàng trong vòng 07&nbsp;ngày kể từ ngày khách hàng nhận
                    được sản phẩm.
                </p>
                <p>Sản phẩm còn nguyên tem, mác và chưa qua sử dụng.</p>
                <p>
                    <strong>3. THỰC HIỆN ĐỔI SẢN PHẨM</strong>
                </p>
                <p>
                ...
                <p>
                    Bước 1: Gọi đến Tổng đài: 0931733469 các ngày trong tuần
